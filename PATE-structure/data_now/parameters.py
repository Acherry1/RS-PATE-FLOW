...
from data_now.pate import set_duplications
...
class DataParameters:
    ...
    def n_private(self):
        ...
        """
        return self.n - self.n_test - self.n_public - self.n_valid
...
class ExperimentParameters:
    ...
    def teachers_dir(self):
        ...
        path = path / f'{self.pate.n_teachers}_teachers_{str(self.pate.eps_short)}_{str(self.pate.distribution["all"])}'
        # path = path / f'{self.pate.n_teachers}_teachers_'
                    ...
                    for eps in self.pate.budgets[collector]:
                        for distribution in self.pate.distributions:
                            ...
                            for label in distribution.keys():
                                epsilon_weights += n_per_label[label] * np.array(distribution[label])
