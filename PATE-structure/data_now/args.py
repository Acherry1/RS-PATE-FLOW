...
def args_parser():
	...
	parser.add_argument('--resume_path', default='checkpoints/dataset_arch_epochs_teacher-num_teacher-id/dataset_arch_epochs_teacher-num_teacher-id.pth', type=str)
	parser.add_argument('--resume_path_root', default='checkpoints/dataset_arch_epochs_teacher-num_teacher-id', type=str)
